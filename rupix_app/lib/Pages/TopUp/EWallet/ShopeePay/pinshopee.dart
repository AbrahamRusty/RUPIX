...
import 'notashopee.dart';

class Pinshopee extends StatelessWidget {
  const Pinshopee({super.key});
...
class _PinEntryPageState extends State<PinEntryPage> {
  ...
  void _onCompleted(List<int> pin) {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const TransaksiBerhasilshopeePage()),
    );
  }
