...
import 'notalinkaja.dart';

class Pinlinkaja extends StatelessWidget {
  const Pinlinkaja({super.key});
...
class _PinEntryPageState extends State<PinEntryPage> {
  ...
  void _onCompleted(List<int> pin) {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const TransaksiBerhasillinkajaPage()),
    );
  }
  ...
  Widget _buildDot(bool filled) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: filled ? const Color(0xFFE52B2B) : Color(0xFF2D2D2D), // Dark unfilled dot
