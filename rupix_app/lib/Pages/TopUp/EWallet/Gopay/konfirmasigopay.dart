...
import 'package:rupix_app/Pages/TopUp/EWallet/Gopay/pingopay.dart';

class KonfirmasigopayPage extends StatelessWidget {
  final String virtualNumber;
  final int nominal;
  final String customerName;
  final String phoneNumber;

  const KonfirmasigopayPage({
    Key? key,
  ...
  Widget build(BuildContext context) {
    int biayaAdmin = 1000;
    String tipePembayaran = "GopayTopup";
            ...
            Row(
              children: [
                CircleAvatar(
                  ...
                  child: Image.asset('assets/Environment/gopay.png', width: 28, height: 28),
                ),
                SizedBox(width: 12),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('GoPayTopup', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Pingopay()),
                  );
                },
