...
class Pinpln extends StatelessWidget {
  const Pinpln({super.key});
...
class _PinEntryPageState extends State<PinEntryPage> {
  ...
  void _onCompleted(List<int> pin) {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const TransaksiBerhasilplnPage()),
    );
  }
  ...
  Widget _buildDot(bool filled) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: filled ? Colors.blueAccent : const Color.fromARGB(77, 111, 111, 111),
