...
import "pinlinkaja.dart";

class KonfirmasilinkajaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: const Color(0xFFE52B2B), // Tetap red LinkAja
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Top Up Button - Tetap red LinkAja
            SizedBox(
              width: double.infinity,
              height: 48,
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Pinlinkaja()),
                  );
                },
